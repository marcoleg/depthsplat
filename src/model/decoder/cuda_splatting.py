...
def render_cuda(
    ...
    h, w = image_shape
    w = 640 # zed ## 640 # airsim # 960 dl3dv
    h = 360 # zed ## 480 # airsim # 540 dl3dv # TODO: rimuovere questo parametro hard-codato e metterlo, IN CASO FOSSE NECESSARIO, dinamico wrt sequenza
